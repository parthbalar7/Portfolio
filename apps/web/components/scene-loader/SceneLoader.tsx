    ...
    <div className={styles['user-message']}>
      <div className={styles['user-message-position-container']}>
        <div className={styles['user-message-container']}>
          <h1>Portfolio of {profile.name}</h1>
          ...
          <p>If you&apos;re interested, you can download my CV from <a href={profile.cvPath} target="_blank">here</a>.</p>
...
function ShowBios() {
  ...
  return (<>
    <div>
      <p>{profile.company ?? 'Magisoft'} - 1998-2024</p>
      <h3>Components</h3>
      <ul>
  ...
  return (
    <div className={styles['loading-progress']}>
      ...
      <div className={styles['error-container']}>
        ...
        <p>Or if you want to download my CV, you can do so from <a href={profile.cvPath} target="_blank">here</a>.</p>
      </div>
    </div>
  );
}
...
function DisplayLoadingFooter() {
  return (
    <>
      <br/>
      <div>
        <p>Loading taking a while? Take a sneak peak at my <a href={profile.cvPath} target="_blank">resume</a>.</p>
      </div>
    </>
  );
}

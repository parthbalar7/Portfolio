      ...
      <div className={styles.content}>
        <div className={styles.locations}>
          ...
          <ul>
            ...
            <li><button className={`system-button ${styles['navigation-btn']} ${mobileClass}`} onClick={() => { onClickLocation('/Users/parth/'); }}>Home</button></li>
            <li><button className={`system-button ${styles['navigation-btn']} ${mobileClass}`} onClick={() => { onClickLocation('/Users/parth/Desktop/'); }}>Desktop</button></li>
            <li><button className={`system-button ${styles['navigation-btn']} ${mobileClass}`} onClick={() => { onClickLocation('/Users/parth/Documents'); }}>Documents</button></li>
          </ul>
        </div>

...
function DutchContent() {
  return (<>
    <p className={styles['contact-info']}>
      I'm open to new opportunities! Whether you have a role in SRE, DevOps, or platform engineering, feel free to reach out. You can contact me via email or fill out the form below.
    </p>
          ...
          <div className={styles['center-content']}>
            <div className={styles['contact-header']}>
              ...
              <div className={styles['contact-socials']}>
                <a rel="noreferrer" target="_blank" href="https://github.com/parthbalar7"><Image src="icons/github-icon.svg" alt="Github" width={22} height={22}/></a>
                <a rel="noreferrer" target="_blank" href="https://linkedin.com/in/parthbalar14"><Image src="icons/linkedin-icon.svg" alt="Linkedin" width={22} height={22}/></a>
              </div>
            </div>
